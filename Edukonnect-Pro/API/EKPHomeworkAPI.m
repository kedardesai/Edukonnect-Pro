...
{
    {
        ...
        //Web Service Call
        NSString *urlString = [NSString stringWithFormat:@"%@%@schoolcode=%@&class_id=%@&pageid=%ld", BASE_API_URL, SCHOOL_SUPPORT_API_URL,currentStudent.studentSchoolCode, currentStudent.studentClass, (long)pageId];
