...
NSString *const ERROR_INVALID_MOBILE_NUMBER = @"Invalid number entered."; // Code : 1006
...
- (void)validateTextFieldAnimated:(BOOL)isAnimated
{
    ...
    switch (self.textFieldtype) {
        ...
        case kTextFieldTypeMobile:
            isValid = [self isTextValidMobileNumber]; // Validate if text entered is decimal number or not.
            break;
